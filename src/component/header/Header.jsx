  ...
  return (
    ...
    <header className="h-screen w-full ">
      ...
      <div className="relative w-full h-full">
        ...
        <div
          className="header-text-box w-fit absolute xsm:left-2 xsm:right-2 sm:left-9 md:left-9 
        lg:left-11 xl:left-11 2xl:left-11 xsm:top-14 sm:top-14 "
        >
          <h1 className="xsm:h4 sm:h3 md:h3 h1 black-text">
            Get the Look You Want
          </h1>
          <h5 className="xsm:h6 sm:h6 md:h6 h5 black-text ">
            Beautifully You Skin Care and Makeup Essentials
          </h5>
          <Button
            classbtn={
              "xsm:mt-16 sm:mt-28  md:mt-32 lg:mt-32 xl:mt-32  mb-8 mx-0"
            }
          >
            shop now
          </Button>
