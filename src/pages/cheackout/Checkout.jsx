  ...
  return (
    <>
      <main className="checkout relative  min-h-[100vh]">
        <div className="w-full h-full flex justify-center  flex-row min-h-[100vh]">
          <div className="contactPart basis-7/12 px-10 pt-10 pb-14">
            <Logo />
            <form action="#" className="mt-8 mx-auto max-w-[660px]">
              <div className="Emailpart h-fit ">
                <div className="relative flex flex-row justify-between items-center  w-[90%] max-w-[600px]">
                ...
                <div className="emailInput pt-4  h-fit">
                  <input
                    type="email"
                    placeholder="Email"
                    className="checkInput block w-[90%] max-w-[600px] bg-transparent h-14 rounded px-4"
                    name="email"
                  />
                </div>
              </div>
              <div className="shppingAdresspart mt-16">
                ...
                <div className="shippingInput   h-fit">
                  <input
                    ...
                    className="checkInput block w-[90%] max-w-[600px] bg-transparent h-14 rounded px-4 my-4"
                    name="country/region"
                  />
                  <div className="fullname  w-[90%] max-w-[600px] flex justify-between">
                    <input
                      type="text"
                  ...
                  <input
                    type="text"
                    placeholder="address"
                    className="checkInput block w-[90%] max-w-[600px] bg-transparent h-14 rounded px-4 my-2"
                    name="address"
                  />
                  <input
                    type="text"
                    placeholder="apartment ,suit, etc "
                    className="checkInput block w-[90%] max-w-[600px] bg-transparent h-14 rounded px-4 my-6"
              ...
              <div className="buttonAndReturnPart  w-[90%] max-w-[590px] flex justify-between items-center">
          ...
          <div className="totalProduct_part basis-5/12 bg-bg-bejiKal pt-20 ">
                {
                ...
                <div className="totalAndsub mx-8 xsm:mx-4 pt-32">
                    <div className="subtotal py-5 mb-10">
                        <p className="text-base font-medium capitalize inline-block float-left">subtotal</p>
                        <p className="subtotalPrice inline-block float-right font-semibold">$122</p>
                    </div>
                    <div className="subtotal py-5">
                        <p className="text-base font-medium capitalize inline-block float-left">total</p>
                        <p className="subtotalPrice inline-block float-right font-semibold">$122</p>
                    </div>
                </div>
          </div>
...
function ProductONCart({name,img,price}){
    ...
    return(
        ...
        <div className="PcartImg w-24 h-20 rounded inline-block mr-6 relative" notiffi="5">
             <img src={img} alt="product image" className="w-full h-full object-fill object-center rounded" />
         </div>
