...
function CartProduct(cartProducte) {
  ...
  const {
    productId: { _id, productImgcard, productName, ProductPrice },
    quantity,
  } = cartProducte;

  return (
    <div
      className="cardtProduct w-[95%] mx-auto rounded bg-bg-bejiKal  mb-7 max-w-[800px]"
      key={_id}
    >
